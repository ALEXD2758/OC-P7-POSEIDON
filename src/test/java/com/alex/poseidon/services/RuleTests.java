...
public class RuleTests {
    ...
    @Test
    public void saveUpdateFindDeleteRuleShouldPerformTheirActionsAndSucceed() {
        ...
        RuleNameModel ruleNameRResult = ruleNameRepository.findById(rule.getId());
        Assert.assertTrue(ruleNameRResult.getTemplate().equals("Template"));
        Assert.assertTrue(ruleNameRResult.getDescription().equals("Description"));
