...
-- Schema paymybuddy
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `poseidon` ;

-- -----------------------------------------------------
-- Schema paymybuddy
-- -----------------------------------------------------
CREATE SCHEMA `poseidon` DEFAULT CHARACTER SET utf8 ;
USE `poseidon` ;

-- -----------------------------------------------------
-- Table `poseidon`.`bidList`
-- -----------------------------------------------------
